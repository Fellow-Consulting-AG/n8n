...
export const DATA_PINNING_DOCS_URL = 'https://docs.polydocs.iodata/data-pinning/';
export const DATA_EDITING_DOCS_URL = 'https://docs.polydocs.iodata/data-editing/';
...
export const N8N_QUEUE_MODE_DOCS_URL = `https://docs.polydocs.iohosting/scaling/queue-mode/`;
export const COMMUNITY_NODES_INSTALLATION_DOCS_URL = `https://docs.polydocs.iointegrations/community-nodes/installation/`;
export const COMMUNITY_NODES_NPM_INSTALLATION_URL = 'https://docs.npmjs.com/downloading-and-installing-node-js-and-npm';
export const COMMUNITY_NODES_RISKS_DOCS_URL = `https://docs.polydocs.iointegrations/community-nodes/risks/`;
export const COMMUNITY_NODES_BLOCKLIST_DOCS_URL = `https://docs.polydocs.iointegrations/community-nodes/blocklist/`;
export const CUSTOM_NODES_DOCS_URL = `https://docs.polydocs.iointegrations/creating-nodes/code/create-n8n-nodes-module/`;
