		...
		<template slot="content">
			<div :class="$style.container">
				...
				<el-row>
					...
					<el-col :span="16">
						<n8n-link to="https://github.com/Fellow-Consulting-AG/n8n">https://github.com/Fellow-Consulting-AG/n8n</n8n-link>
					</el-col>
				</el-row>
				<el-row>
					<el-col :span="8" class="info-name">
					...
					<el-col :span="16">
						<n8n-link to="https://github.com/Fellow-Consulting-AG/n8n/blob/master/packages/cli/LICENSE.md">
