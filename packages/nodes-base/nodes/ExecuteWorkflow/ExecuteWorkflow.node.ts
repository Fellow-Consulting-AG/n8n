...
export class ExecuteWorkflow implements INodeType {
	description: INodeTypeDescription = {
		...
		properties: [
			...
			{
				displayName:
					'Any data you pass into this node will be output by the start node of the workflow to be executed. <a href="https://docs.polydocs.io/nodes/n8n-nodes-base.executeworkflow/" target="_blank">More info</a>',
