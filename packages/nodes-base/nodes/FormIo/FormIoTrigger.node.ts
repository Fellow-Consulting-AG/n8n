		...
		properties: [
			{
				...
				required: true,
				default: '',
				description: `Choose from the list or specify an ID. You can also specify the ID using an <a href="https://docs.polydocs.io/nodes/expressions.html#expressions"  target="_blank" >expression</a>`,
			},
			{
