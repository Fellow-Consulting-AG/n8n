...
export const observableFields: INodeProperties[] = [
	...
	},
	{
		...
		description:
			'Type of the observable. Choose from the list, or specify an ID using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
	},
	{
		displayName: 'Data',
		name: 'data',
		...
		options: [
			{
				...
				description:
					'Type of the observable. Choose from the list, or specify IDs using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
			},
			{
