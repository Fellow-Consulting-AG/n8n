...
export const responderFields: INodeProperties[] = [
	{
		...
		description:
			'Choose the responder. Choose from the list, or specify an ID using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
	},
	{
		...
		default: '',
		description:
			'Choose the Data type. Choose from the list, or specify an ID using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
	},
	{
