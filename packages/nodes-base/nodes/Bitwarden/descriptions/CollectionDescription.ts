		...
		options: [
			{
				...
				type: 'multiOptions',
				description:
					'The group to assign this collection to. Choose from the list, or specify IDs using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
				default: [],
				typeOptions: {
