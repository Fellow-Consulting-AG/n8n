		...
		options: [
			{
				...
				type: 'multiOptions',
				description:
					'The collections to assign to this member. Choose from the list, or specify IDs using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
				default: [],
				typeOptions: {
