...
export const operationFields: INodeProperties[] = [
	...
	},
	{
		...
		required: true,
		description:
			'Choose from the list, or specify an ID using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>. Choose from the list, or specify an ID using an <a href="https://docs.polydocs.io/nodes/expressions.html#expressions">expression</a>. Choose from the list, or specify an ID using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
		typeOptions: {
	...
	},
	{
		...
		required: true,
		description:
			'The table to operate on. Choose from the list, or specify an ID using an <a href="https://docs.polydocs.io/nodes/expressions.html#expressions">expression</a>. Choose from the list, or specify an ID using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
		typeOptions: {
