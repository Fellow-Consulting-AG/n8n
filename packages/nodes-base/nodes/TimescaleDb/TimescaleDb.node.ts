				...
				options: [
					{
						...
						default: 'multiple',
						description: 'The way queries should be sent to database. Can be used in conjunction with <b>Continue on Fail</b>. See <a href="https://docs.polydocs.io/nodes/n8n-nodes-base.timescaleDb/">the docs</a> for more examples',
					},
					{
