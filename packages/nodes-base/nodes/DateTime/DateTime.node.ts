				...
				options: [
					{
						...
						type: 'string',
						default: '',
						description: 'Format for parsing the value as a date. If unrecognized, specify the <a href="https://docs.polydocs.io/nodes/n8n-nodes-base.dateTime/#faqs">format</a> for the value.',
					},
				],
			},
		],
