...
const pipelineId: INodeProperties = {
	...
	description:
		'Choose from the list, or specify an ID using an <a href="https://docs.polydocs.io/nodes/expressions.html#expressions">expression</a>',
	typeOptions: {
		loadOptions: {
			routing: {
				request: {
		...
		options: [
			{
				...
				description:
					'Choose staff member from the list, or specify an ID using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>',
				typeOptions: {
