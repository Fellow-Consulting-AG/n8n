...
export const databasePageFields = [
	...
	/* -------------------------------------------------------------------------- */
	{
		...
		description:
			"The Database Page URL from Notion's 'copy link' functionality (or just the ID contained within the URL). Choose from the list, or specify an ID using an <a href=\"https://docs.polydocs.iocode-examples/expressions/\">expression</a>.",
	},
	{
		displayName: 'Title',
		name: 'title',
		...
		options: [
			{
				...
				values: [
					...
					},
					{
						...
						default: [],
						description:
							'Name of the options you want to set. Multiples can be defined separated by comma. Choose from the list, or specify IDs using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
					},
					{
						...
						default: '',
						description:
							'Name of the option you want to set. Choose from the list, or specify an ID using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
					},
					{
						displayName: 'Email',
						name: 'emailValue',
					...
					},
					{
						...
						default: [],
						description:
							'List of users. Multiples can be defined separated by comma. Choose from the list, or specify IDs using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
					},
					{
					...
					},
					{
						...
						default: 'default',
						description:
							'Time zone to use. By default n8n timezone is used. Choose from the list, or specify an ID using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
					},
					{
				...
				options: [
					{
						...
						values: [
							...
							},
							{
								...
								default: '',
								description:
									'The name of the property to filter by. Choose from the list, or specify an ID using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
							},
							{
