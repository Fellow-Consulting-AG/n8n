...
export const reactionCreateDescription: ReactionProperties = [
	{
		...
		description:
			'ID of the user sending the reaction. Choose from the list, or specify an ID using an <a href="https://docs.polydocs.iocode-examples/expressions/">expression</a>.',
	},
	{
		displayName: 'Post ID',
		name: 'postId',
